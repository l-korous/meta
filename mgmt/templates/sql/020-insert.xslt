...
IF OBJECT_ID ('dbo.insert_<xsl:value-of select="@table_name" />') IS NOT NULL 
     DROP PROCEDURE dbo.insert_<xsl:value-of select="@table_name" />
GO
CREATE PROCEDURE dbo.insert_<xsl:value-of select="@table_name" />(

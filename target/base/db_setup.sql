...
USE master
IF (EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE ('[' + name + ']' = 'meta3' OR name = 'meta3')))
    BEGIN
	   ALTER DATABASE meta3 SET single_user WITH ROLLBACK IMMEDIATE;
	   DROP DATABASE meta3
    END
GO
CREATE DATABASE meta3;
GO
use meta3;
GO

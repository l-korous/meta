...
BEGIN
    ...
    BEGIN TRY
       ...
       -- Conflict check
            ...
            TRUNCATE TABLE dbo.conflicts_A
            TRUNCATE TABLE dbo.conflicts_AtC
            TRUNCATE TABLE dbo.conflicts_B
            TRUNCATE TABLE dbo.conflicts_C
        IF @force_merge = 0 BEGIN
        DECLARE @number_of_conflicts int = 0, @number_of_conflicts_util int
        
            EXEC dbo.identify_conflicts_A @branch_id, @merge_version_id, @min_version_order_master, @number_of_conflicts_util output
            set @number_of_conflicts = @number_of_conflicts + @number_of_conflicts_util
        
            EXEC dbo.identify_conflicts_AtC @branch_id, @merge_version_id, @min_version_order_master, @number_of_conflicts_util output
            set @number_of_conflicts = @number_of_conflicts + @number_of_conflicts_util
        
            EXEC dbo.identify_conflicts_B @branch_id, @merge_version_id, @min_version_order_master, @number_of_conflicts_util output
            set @number_of_conflicts = @number_of_conflicts + @number_of_conflicts_util
        
            EXEC dbo.identify_conflicts_C @branch_id, @merge_version_id, @min_version_order_master, @number_of_conflicts_util output
            set @number_of_conflicts = @number_of_conflicts + @number_of_conflicts_util
       ...
       EXEC sp_MSforeachtable "ALTER TABLE ? NOCHECK CONSTRAINT all"
            ...
            EXEC dbo.perform_merge_A @branch_id, @merge_version_id, @current_datetime
        
            EXEC dbo.perform_merge_AtC @branch_id, @merge_version_id, @current_datetime
        
            EXEC dbo.perform_merge_B @branch_id, @merge_version_id, @current_datetime
        
            EXEC dbo.perform_merge_C @branch_id, @merge_version_id, @current_datetime
